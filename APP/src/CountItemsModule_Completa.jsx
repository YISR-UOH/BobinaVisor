...
import { useCountItems_COMPLETA } from "./hooks/useCountItems_COMPLETA";
import "./style.css";

export default function CountItemsModule_COMPLETA({ files, setTotalItems }) {
  const { data, loading, error } = useCountItems_COMPLETA(files);
  ...
  return (
    <section className="my-6">
      <h2 className="text-lg font-semibold text-slate-900">
        Conteo de rollos por código y ancho (turno actual, Completa)
      </h2>
